...
def selecionar_rois(imagem):
    ...
    while True:
        ...
        # Ajuste a janela para o tamanho da imagem
        altura, largura = img.shape[:2]
        cv2.resizeWindow('ROI', largura, altura)
...
caminho_video = 'C:/Users/usuario/Desktop/Inteligencia Artificial/visao-comp-detecta-fogo/fire-detection/videoplayback2.mp4'
